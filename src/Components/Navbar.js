...
function Nav (props) {
    return (
        <div id='list' className="list">
            <ul>
                <li><a href={props.link1}>Accueil</a></li>
                <li><a href={props.link2}>Emplois</a></li>
                <li><a href={props.link3}>Publier un job</a></li>
                <li><a href={props.link4}>A props de nous</a></li>
            </ul>
        </div>
    );
}
